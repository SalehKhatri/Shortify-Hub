...
function AllLinks() {
  ...
  return (
    ...
    <div className='text-white flex flex-col gap-2 mt-4 w-[90%] sm:w-[70%] border border-purple-400 shadow-[0_0_23px_1px_rgba(192,132,252,0.7)] rounded-md  p-[6px] sm:p-5 h-[25vh] scrollbar-thin   scrollbar-thumb-purple-600 scrollbar-track-purple-300 scrollbar-thumb-rounded scrollbar-track-rounded overflow-y-auto '>
